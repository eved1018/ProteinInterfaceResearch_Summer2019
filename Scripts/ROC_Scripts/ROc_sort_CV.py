...
def ROC_sort_cv():
    ...
    RF_dir="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/tests"
    for folder in os.listdir(RF_dir):
        if folder.startswith("CV"):
            os.mkdir("/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/CVbyPDB/{}".format(folder))
            folder_der = "/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/tests/{}".format(folder)
            for filename in os.listdir(folder_der):
                if filename.startswith("RF"): 
                    print("{} in {}".format(filename, folder))
                    path ="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/tests/{}/{}".format(folder,filename)
                    ...
                    for i in proteinids : 
                        ...
                        path="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/CVbyPDB/{}/RFval{}.csv".format(folder,i)
...
def ROC_thresh():
    ...
    bypdbfolders = "/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/CVbyPDB"
            ...
            for i in np.arange(0.00, 1.02, .01):
                ...
                for filename in os.listdir(proteinfolder):
                    ...
                    if threshhold == 0 :
                        ...
                        # print(results.head())
                        path="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/zeros/{}ZeroThresholdtest.csv".format(folder)
                ...
                path="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/Crossveltest1/results/{}results.csv".format(folder)
