...
my $preddir = </Users/mordechaiwalder/Desktop/Research_Mordechai/Data_Files/Dock_freq/Sorted_adjusted/>;
...
my $ROC_File = </Users/mordechaiwalder/Desktop/Research_Mordechai/Results/ROC_Curves_Results/ROC_Data/Dock_freq/Dock_freq.ROC.thresholds.csv>;
...
my $Zero_Threshold_File = </Users/mordechaiwalder/Desktop/Research_Mordechai/Results/ROC_Curves_Results/ROC_Data/Dock_freq/Dock_freq.ROC.zero_threshold.proteins.csv>;
...
for 0, 1.01, 0.01 -> $start, $stop, $inc
 {
   ...
   for (@seq) -> $threshold {
    ...
    #     say "my seqres = ", $Seqres;
        ...
        #    say $NOX_protein;
            my $NOX_protein_dock = "$preddir$NOX_protein.docking_freq_sorted.csv";
            for $file.IO.lines -> $line {
              my ($annres_num, $annres) = $line.split('_');
              @annotatedres.push: $annres_num;
            }
