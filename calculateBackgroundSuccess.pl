...
( $#ARGV > 0 )
  or die
"usage: $0<total residues (sampled)><annotated interface residues (sampled>><optional: number of draws (default=200)><optional: size of drawn set (default:15)>";
