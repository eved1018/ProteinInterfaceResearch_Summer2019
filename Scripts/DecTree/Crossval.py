...
def CrossVal():
    ...
    for i in range(0,len(chunks)):
        ...
        time = i+1
        # print("train frame {}".format(time))
        # print(train_frame)
        # print("test frame {}".format(time))
        # print(test_frame)
        ...
        pathtest=path="/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Data_Files/Logistic_regresion_corrected/CrossVal/CV{}/testframe{}.csv".format(time,time)
        train_frame.to_csv(pathtest,sep=",", index=False, header=True)
    ...
    # print(test_frame.axes)
    # print(train_frame.axes)
    # print(data.axes)
