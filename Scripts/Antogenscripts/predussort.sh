...
#     cat $file | awk -v var=$proteinname -F, '{print $1=$1"_"var "," $2}'  >> /Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Antogen/predictionvalue/predussort.csv
# done 

for file in /Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Antogen/predictionvalue/res_pred/ispred/*
do 
    predfile=/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Antogen/predictionvalue/predussort.csv
    dockfile=/Users/evanedelstein/Desktop/Research_Evan/Raji_Summer2019_atom/Antogen/predictionvalue/ispred.csv
    cat $file | awk -F, '{print $1","$2}' |sed 's/^ *//g' | less
    # cat $file | awk -F, '{print $2}'|sed 's/^ *//g'| paste -d "," $predfile - > $dockfile
done 